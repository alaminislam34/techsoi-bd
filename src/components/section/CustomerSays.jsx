                ...
                <div className="flex justify-between">
                  ...
                  <div className="flex justify-center items-center">
                    <div className="flex justify-center items-center gap-1 px-2.5 py-1.5 rounded-lg bg-[#eaf7fc]">
                      ...
                      <span className="text-[#185f7c]">5.0</span>
                    </div>
                  </div>
                </div>
                <p className="text-[14px] md:text-xl text-[#4b5565]">
                  আমি TechSoi থেকে একটা গেমিং ল্যাপটপ কিনেছি দামটা একদম
                  জাস্টিফায়েড, প্রোডাক্ট একেবারে অরিজিনাল আর প্যাকেজিংও সেফ ছিল।
                  কাস্টমার সাপোর্টও খুব দ্রুত রিপ্লাই দিয়েছে। আমি ভীষণ খুশি
                </p>
              </div>
            </div>
          </SwiperSlide>
